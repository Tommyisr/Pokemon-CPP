...
class WorldLocationIsOutOfRange: public WorldException {
};
class WorldLocationsAlreadyConnected: public WorldException {
};
class WorldIsConnectedToItsLimit: public WorldException {
};
class WorldLocationNameCannotBeFound: public WorldException {
};
class WorldLocationAreNotConnected: public WorldException {
};
